...
> **Status:** `0.1.1` release, tested successfully as a Windows screen saver.
...
The `0.1.1` release is unsigned. Verify the SHA-256 file provided with the release before use.
